function sim_lsl_nirx(lib,path2folder,streaming_type)
%SIM_LSL_NIRX Simulates metadata and data lsl streams using nirstoolbox.
% 
% Arguments
% Input 
% 
% lib               : lsl library, e.g., lib = lsl_loadlib();
% path2folder         : full path to NIRx scan folder
