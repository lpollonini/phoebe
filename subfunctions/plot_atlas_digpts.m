...
handles.h_src_left = scatter3(handles.axes_left,handles.src_pts(:,1), handles.src_pts(:,2), handles.src_pts(:,3),80,'r','SizeData',60,'LineWidth',2); % Plots sources
handles.h_det_left = scatter3(handles.axes_left,handles.det_pts(:,1), handles.det_pts(:,2), handles.det_pts(:,3),80,'b','s','SizeData',60,'LineWidth',2); % Plots detectors
...
if get(handles.uipanel_head,'SelectedObject')==handles.radiobutton_doubleview
    ...
    handles.h_src_right = scatter3(handles.axes_right,handles.src_pts(:,1), handles.src_pts(:,2), handles.src_pts(:,3),60,'r','SizeData',60,'LineWidth',2); 
    handles.h_det_right = scatter3(handles.axes_right,handles.det_pts(:,1), handles.det_pts(:,2), handles.det_pts(:,3),60,'b','s','SizeData',60,'LineWidth',2);
